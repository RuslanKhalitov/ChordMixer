"""
Afapted from
https://github.com/david-knigge/ccnn/blob/main/datamodules/cifar10.py
"""
...
class PathfinderX(pl.LightningDataModule):
    def __init__(
        self,
        data_dir,
        num_workers,
    ...
    def setup(self, stage=None):
        dataset = PathFinderXDataset(self.data_dir, transform=self.transform)
